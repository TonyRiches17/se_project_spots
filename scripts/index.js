...
const addCardModalLinkInput = addCardModal.querySelector("#add-card-link-input");
const addCardModalNameInput = addCardModal.querySelector("#add-card-name-input");
...
function handleAddCardFormSubmit(evt) {
  evt.preventDefault();
  const inputValues = {name: addCardModalNameInput.value, link: addCardModalLinkInput.value };
